<div class="text-page">
	<h2>About Find My Feet</h2>

	<p>Plan routes to places, get info about the surrounding area, store them offline with the HTML5 offline storage cache manifest.</p>
	...
	<ul>
		...
		<li><strong>Nisha</strong>: Presentation writer, User</li>
	</ul>
</div>
